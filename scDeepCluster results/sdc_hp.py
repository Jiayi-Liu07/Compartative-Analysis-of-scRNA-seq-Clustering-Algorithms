...
####################################  Read dataset  ####################################
data_mat = h5py.File('/gpfs/work/bio/jiayiliu20/scAce-code/scDeepCluster/reproducibility/data/Human_p.h5')
...
np.savez("/gpfs/work/bio/jiayiliu20/scAce-code/scDeepCluster/results_new/hp_scDeepcluster_wo_sample.npz", ARI=ari, NMI=nmi,
         Clusters=y_pred, Labels=y, Time_use=run_time)
...
scd = np.load("/gpfs/work/bio/jiayiliu20/scAce-code/scDeepCluster/results_new/hp_scDeepcluster_wo_sample.npz")
y_pred = scd["Clusters"]
y = scd["Labels"]
print(adata)
print(y_pred)
