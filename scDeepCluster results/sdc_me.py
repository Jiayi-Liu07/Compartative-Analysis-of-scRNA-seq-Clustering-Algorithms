...
np.savez("/gpfs/work/bio/jiayiliu20/scAce-code/scDeepCluster/results_new/me_scDeepcluster_wo_sample.npz", ARI=ari, NMI=nmi,
         Clusters=y_pred, Labels=y, Time_use=run_time)
...
scd = np.load("/gpfs/work/bio/jiayiliu20/scAce-code/scDeepCluster/results_new/me_scDeepcluster_wo_sample.npz")
y_pred = scd["Clusters"]
y = scd["Labels"]
print(adata)
print(y_pred)
