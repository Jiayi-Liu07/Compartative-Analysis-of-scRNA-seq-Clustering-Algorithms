...
data_mat = h5py.File('/gpfs/work/bio/jiayiliu20/scAce-code/reproducibility/data/Human_PBMC.h5')
...
adata, nmi, ari, K, pred_all, emb_all, run_time = run_scace(
    ...
    return_all=True,
    save_pretrain=True,
    saved_ckpt='/gpfs/work/bio/jiayiliu20/scAce-code/pretraining/scace_hpbmc.pth'
)
...
plt.savefig('/gpfs/work/bio/jiayiliu20/scAce-code/visualization/hpbmc_final_clustering.svg', dpi=300, format='svg', bbox_inches='tight')
...
plt.savefig('/gpfs/work/bio/jiayiliu20/scAce-code/visualization/hpbmc_initial_clustering.svg', dpi=300, format='svg', bbox_inches='tight')
...
plt.savefig('/gpfs/work/bio/jiayiliu20/scAce-code/visualization/hpbmc_compare_initial.svg', dpi=300, format='svg', bbox_inches='tight')
...
sc.tl.umap(adata_tmp)
sc.pl.umap(adata_tmp, color=['scace_before', 'scace_after', 'celltype'])
plt.savefig('/gpfs/work/bio/jiayiliu20/scAce-code/visualization/hpbmc_compare_final.svg', dpi=300, format='svg', bbox_inches='tight')
