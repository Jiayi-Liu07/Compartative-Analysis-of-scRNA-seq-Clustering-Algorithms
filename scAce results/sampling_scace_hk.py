...
for i in range(total_rounds):
    ...
    adata, nmi, ari, K, _, _, _ = run_scace(
        ...
        return_all=True,
        save_pretrain=True,
        saved_ckpt='/gpfs/work/bio/jiayiliu20/scAce-code/pretraining/scace_hk_sampling.pth'
    )
...
np.savez("results/scAce_with_sample_hk.npz", ARI=ari_all, NMI=nmi_all, K=k_all,
